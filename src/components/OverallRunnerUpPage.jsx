...
const OverallRunnerUpPage = () => {
  ...
  // totalPoints = sports + arts combined
  ...
  const entries = runnerUp
    ? [
        {
          designation: `Overall Runner Up • ${runnerUp.totalPoints ?? 0} pts`,
          houseName: runnerUp.houseName,
          logo: getHouseLogo(runnerUp.houseName),
        },
      ]
    : [];
...
export default OverallRunnerUpPage;